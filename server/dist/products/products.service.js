...
let ProductsService = exports.ProductsService = class ProductsService {
    ...
    async findAll(role, categoryId, cartId) {
    ...
    async update(id, updateProductDto, fileName) {
        if (fileName) {
            ...
            updateProductDto = Object.assign(Object.assign({}, updateProductDto), { image: fileName });
        }
    ...
    async updateOnCartCheckout(updateCartItemDto) {
        return await this.productsRepository.updateOnCartCheckout(updateCartItemDto);
    }
    async rollbackInventory(updateCartItemDto) {
