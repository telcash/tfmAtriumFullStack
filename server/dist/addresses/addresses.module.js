...
let AddressesModule = exports.AddressesModule = class AddressesModule {
};
exports.AddressesModule = AddressesModule = __decorate([
    (0, common_1.Module)({
        controllers: [addresses_controller_1.AddressesController],
        providers: [addresses_service_1.AddressesService, addresses_repository_1.AddressesRepository],
