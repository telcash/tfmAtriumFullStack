...
const user_delete_guard_1 = require("./guards/user-delete.guard");
const user_role_1 = require("./constants/user-role");
const user_decorator_1 = require("./decorators/user.decorator");
const signup_pipe_1 = require("../auth/pipes/signup.pipe");
const user_delete_check_orders_interceptor_1 = require("./interceptors/user-delete-check-orders.interceptor");
...
__decorate([
    (0, common_1.UseGuards)(user_delete_guard_1.UserDeleteGuard),
    (0, common_1.UseInterceptors)(user_delete_check_orders_interceptor_1.UserDeleteCheckOrdersInterceptor),
...
__decorate([
    (0, common_1.UseGuards)(user_delete_guard_1.UserDeleteGuard, role_guard_1.RoleGuard),
    (0, roles_decorator_1.Roles)(user_role_1.UserRole.ADMIN),
    (0, common_1.UseInterceptors)(user_delete_check_orders_interceptor_1.UserDeleteCheckOrdersInterceptor),
