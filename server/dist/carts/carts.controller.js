...
const checkout_pipe_1 = require("./pipes/checkout.pipe");
...
let CartsController = exports.CartsController = class CartsController {
    ...
    async updateMyCart(cart, updateCartDto) {
        return new cart_entity_1.CartEntity(await this.cartsService.updateMyCart(cart.id, updateCartDto));
    }
